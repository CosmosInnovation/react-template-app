...
import { NavItemProps, mainNavigation } from "./constants/HeaderTopMenuList";
...
function HeaderMenu() {
  ...
  return (
    <div className='fixed top-0 z-10 w-full flex items-center  p-4 2xl:flex-row xl:flex-row l:flex-row md:flex-row sm:flex-row bg-white'>
      {/* Toast container  */}
